 ...
 */
function gather_sanitize_text( $string ) {
	global $allowedtags;
...
if ( ! function_exists( 'gather_sanitize_choices' ) ) :
/**
 ...
 */
function gather_sanitize_choices( $value, $setting ) {
	if ( is_object( $setting ) ) {
		$setting = $setting->id;
	}

	$choices = gather_get_choices( $setting );
	$allowed_choices = array_keys( $choices );

	if ( ! in_array( $value, $allowed_choices ) ) {
		$value = gather_get_default( $setting );
	}
...
if ( ! function_exists( 'gather_sanitize_file_url' ) ) :
/**
 ...
 */
function gather_sanitize_file_url( $url ) {
